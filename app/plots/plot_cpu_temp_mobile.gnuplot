...
set output "/var/www/html/pimon/cpu_temp_mobile.png"
set title "CPU temp - 24h" textcolor rgb "#4c4f69"
set ylabel "C" textcolor rgb "#4c4f69"

plot "< sqlite3 /opt/pimon/db/pimon.db \"SELECT ts_utc, cpu_temp_c FROM pi_tick WHERE ts_utc >= datetime('now','-1 day') ORDER BY id;\"" using 1:2 with lines lw 2 lc rgb "#1e66f5" title ""
